...
import { PaginationComponent } from '../../interviewer-dashboard/pagination/pagination.component';
import { InterviewerService, InterviewRequest } from '../../interviewer-dashboard/services/interviewer.service';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, CandidateSidebarComponent, PaginationComponent],
  templateUrl: './upcoming-interviews.component.html',
  styleUrls: ['./upcoming-interviews.component.css'],
})
export class CandidateUpcomingInterviewsComponent implements OnInit {
  ...
  hasValidMeeting(interview: any): boolean {
    return !!interview.meetingId;
  }

  joinZoomMeeting(interview: any, event: Event): void {
